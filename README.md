...
Note #2: If you place the Monolith folder in a drive other than the C: drive, then you must move to that drive first before the cd command will move you to the right location. To accomplish this, simply type "(drive letter):" in command promot (i.e. if you put the Monolith folder in your D: drive, type "D:" in the command prompt and it will move you there, allowing you to use the cd command properly).
