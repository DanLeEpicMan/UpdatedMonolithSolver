...
Note for Step 6: Ideally, you wan't at least 90%, since it's almost guaranteed to work with minimal manual clearing. If you get below 80%, I reccommend just starting over since you will have to do a lot of manual clearing. There's no clear board option so unfortunately you just have to spam click the board until you can start a new game.
