...
Step 5: Once you have your file created, go back to the Anaconda command prompt and type this: "python THM.py yourname" (without quotes!). yourname is whatever you named your file, without the .csv at the end. For example, I would type "python THM.py myBoard" (without quotes!)
